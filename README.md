...
- **签到与领取积分的接口(`signin/page/info`、`market/signin/page/receive` 等)目前返回 404,已被官方下架**;因此无法通过接口查看或领取云朵余额,也无法自动「每日签到」。
- 任务如 106(手动上传)、434(分享文件)、409(访问云朵中心)、113(PC客户端)、604(云盘图书馆阅读)需要真实人工操作,纯接口点击无法完成 `FINISH`。
- 上传接口目前鉴权受限,暂未能通过脚本完成「上传文件」任务。
